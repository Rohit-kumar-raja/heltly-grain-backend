...
`,Jt={root:function(t){var o=t.props,e=t.instance;return["p-badge p-component",{"p-badge-circle":W(o.value)&&String(o.value).length===1,"p-badge-dot":Q(o.value)&&!e.$slots.default,"p-badge-sm":o.size==="small","p-badge-lg":o.size==="large","p-badge-xl":o.size==="xlarge","p-badge-info":o.severity==="info","p-badge-success":o.severity==="success","p-badge-warn":o.severity==="warn","p-badge-danger":o.severity==="danger","p-badge-secondary":o.severity==="secondary","p-badge-contrast":o.severity==="contrast"}]}},qt=v.extend({name:"badge",style:Zt,classes:Jt}),tn={name:"BaseBadge",extends:X,props:{value:{type:[String,Number],default:null},severity:{type:String,default:null},size:{type:String,default:null}},style:qt,provide:function(){return{$pcBadge:this,$parentInstance:this}}};function E(n){"@babel/helpers - typeof";return E=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(t){return typeof t}:function(t){return t&&typeof Symbol=="function"&&t.constructor===Symbol&&t!==Symbol.prototype?"symbol":typeof t},E(n)}function it(n,t,o){return(t=nn(t))in n?Object.defineProperty(n,t,{value:o,enumerable:!0,configurable:!0,writable:!0}):n[t]=o,n}function nn(n){var t=on(n,"string");return E(t)=="symbol"?t:t+""}function on(n,t){if(E(n)!="object"||!n)return n;var o=n[Symbol.toPrimitive];if(o!==void 0){var e=o.call(n,t);if(E(e)!="object")return e;throw new TypeError("@@toPrimitive must return a primitive value.")}return(t==="string"?String:Number)(n)}var bt={name:"Badge",extends:tn,inheritAttrs:!1,computed:{dataP:function(){return A(it(it({circle:this.value!=null&&String(this.value).length===1,empty:this.value==null&&!this.$slots.default},this.severity,this.severity),this.size,this.size))}}},en=["data-p"];function rn(n,t,o,e,r,i){return k(),j("span",f({class:n.cx("root"),"data-p":i.dataP},n.ptmi("root")),[C(n.$slots,"default",{},function(){return[$t(dt(n.value),1)]})],16,en)}bt.render=rn;var an=`
    .p-ink {
        display: block;
        position: absolute;
